...
export const Header = () => {
  ...
  const handleSubmit = (e) => {
    ...
    return (
    <header>
      <nav className=" border-b-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-r-slate-900 dark:border-b-1 py-2 px-2">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={viteLogo} className="h-8 text-2xl" alt=" Logo mr-2" />
          ...
          {/* Toggle visibility using state only */}
          <div
